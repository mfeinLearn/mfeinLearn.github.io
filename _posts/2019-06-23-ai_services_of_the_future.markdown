...
A blog about AI services of the future!
...
Other routes that I have are the following:
resources :users
resources :services
resources :transactions

Their is one more resources that I have which is called a nested resources. It looks like this:
